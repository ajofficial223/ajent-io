        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              {[
                { icon: <Twitter size={18} />, label: "Twitter", url: "https://twitter.com/ajentio" },
                { icon: <Linkedin size={18} />, label: "LinkedIn", url: "https://linkedin.com/company/ajentio" },
                { icon: <Instagram size={18} />, label: "Instagram", url: "https://instagram.com/ajentio" },
                { icon: <Facebook size={18} />, label: "Facebook", url: "https://facebook.com/ajentio" },
                { icon: <Youtube size={18} />, label: "YouTube", url: "https://youtube.com/c/ajentio" }
              ].map((social, index) => (
                <a
                  key={index}
                  href={social.url}
